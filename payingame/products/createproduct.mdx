...
These products can then be sold by putting a price on them. Bare in mind that NFT's can only be sold on-chain and <b>not by FIAT payments (through Stripe)</b>
